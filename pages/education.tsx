...
export const Education = () => {
  ...
  return (
    <>
      <Head>
        <title>Medical Staff - Nurses Education</title>
      </Head>
            ...
            <div className="row">
              <div className="col-md-8">
                <p>
                  ...
                  <br />
                  <br />
                  Medical Staff organises online courses throughout the year as
                  ...
                  such as Local Health District policies and procedures,
                  orientation information and more. We also offer training to
                  overseas nurses who are new to the country.
                  <br />
                  <br />
                  Training on ACFI is provided by our Aged Care Educator on
                  regular basis.
                  <br />
                  <br />
                  Contact our team for further information. Current nurses are
                  contacted by our Education and Compliances team on a regular
                  basis to keep you up to date with these requirements.
                </p>
              </div>
